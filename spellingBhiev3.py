...
# Theme colors (ROSE GOLD themed kita) - kept for some elements, but background is now image
THEME_FG = "white"  # text
BUTTON_BG = ""  # Changed to empty string for transparency
...
class SpellingGame:
    def __init__(self, root):
        ...
        self.start_button = tk.Button(self.canvas, text="Start Game", command=self.start_intro, bg=BUTTON_BG, fg=BUTTON_FG, font=FONT, relief='flat', bd=0)
        ...
        self.play_sound_button = tk.Button(self.canvas, text="Play Sound", command=self.play_sound, bg=BUTTON_BG, fg=BUTTON_FG, font=FONT, relief='flat', bd=0)
        ...
        self.submit_button = tk.Button(self.canvas, text="Enter", command=self.check_answer, bg=BUTTON_BG, fg=BUTTON_FG, font=FONT, relief='flat', bd=0)
        self.score_label = tk.Label(self.canvas, text=f"Score: {self.score}", bg="#C38888", fg=THEME_FG, font=FONT)
        self.skip_button = tk.Button(self.canvas, text="Skip", command=self.skip_word, bg=BUTTON_BG, fg=BUTTON_FG, font=FONT, relief='flat', bd=0)
